...
public class EntityAIStatic extends AIAnimation {
	...
	public boolean shouldAnimate() {
		...
		if(living.getAttackTarget() == null || living.getDistanceSqToEntity(living.getAttackTarget()) > 64D || !living.getEntitySenses().canSee(living.getAttackTarget())) return false;
