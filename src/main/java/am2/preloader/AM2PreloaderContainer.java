...
public class AM2PreloaderContainer extends DummyModContainer implements IFMLLoadingPlugin{
	...
	public AM2PreloaderContainer(){
		...
		AMCore.log.info("Core initializing...stand back!  I'm going to try MAGIC!");
	...
	public void injectData(Map<String, Object> data){
		...
		AMCore.log.trace("MC located at: " + loc.getAbsolutePath());
		...
		for (File f : subfiles){
			if (f.getName() != null){
				if (f.getName().toLowerCase().contains("thaumcraft")){
					AMCore.log.info("Core: Located Thaumcraft");
					foundThaumcraft = true;
				}else if (f.getName().toLowerCase().contains("optifine")){
					AMCore.log.info("Core: Located Optifine");
					foundOptifine = true;
				}
			}
		}
